...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: "category",
      title: "Category",
      description: "Project category e.g. Commercial, Cat A, Residential",
      type: "reference",
      group: "overview",
    ...
    defineField({
      ...
      description:
        "Main project image — shown in listings and at the top of the project page.",
      type: "image",
      group: "images",
    ...
    defineField({
      ...
      description: "Select from existing expertise tags or create new ones.",
      type: "array",
      group: "stats",
    ...
    defineField({
      name: "team",
      title: "Team Members",
      description: "Select the team members who worked on this project.",
      type: "array",
      group: "stats",
    ...
    defineField({
      ...
      title: "Project stats",
      description:
        "Flexible project details shown as a stat grid at the top of the project page.",
      type: "array",
      group: "stats",
      of: [
        {
    ...
    defineField({
      ...
      description: "Brief from the client — what they wanted to achieve",
      type: "text",
      rows: 5,
      group: "client",
    }),
    defineField({
      ...
      description: "Quote or testimonial from the client about the project",
      type: "text",
      rows: 5,
      group: "client",
    }),
