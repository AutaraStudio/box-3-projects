...
const homePage = [
  ...
  field("Hero image", "Full-bleed background photo used when Background media is set to Image. Has its own Alt text sub-field."),
...
const servicesPage = [
  ...
  field("Image", "Editorial photograph beside / below the body. Has an Alt text sub-field."),
...
const sustainabilityPage = [
  ...
  field("Hero image — left / centre / right", "Three-image scroll-driven hero. The centre image expands from ~50% width to full-bleed as the user scrolls. Each has its own Alt text."),
  h("Intro", HeadingLevel.HEADING_3),
  field("Intro heading", ""),
...
const collections = [
  ...
  field("Featured image", "The cover image — used on the listing card, the project hero, and the first slide of the lightbox. Use \"Pick from library\" and pick by tag for speed. Has its own Alt text — required."),
